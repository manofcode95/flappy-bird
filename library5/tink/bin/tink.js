  ...
  _createClass(Tink, [
    {
      ...
      value: function makeDraggable() {
        ...
        for (
          var _len = arguments.length, sprites = Array(_len), _key = 0;
          _key < _len;
          _key++
        ) {
    ...
    },
    {
      ...
      value: function makeUndraggable() {
        ...
        for (
          var _len2 = arguments.length, sprites = Array(_len2), _key2 = 0;
          _key2 < _len2;
          _key2++
        ) {
        ...
        sprites.forEach(function(sprite) {
          _this2.draggableSprites.splice(
            _this2.draggableSprites.indexOf(sprite),
            1
          );
    ...
    },
    {
      ...
      value: function makePointer() {
        ...
        window.addEventListener(
          "mouseup",
          pointer.upHandler.bind(pointer),
          false
        );
